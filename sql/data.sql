...
INSERT INTO techniques(technique_name, CE_cost, damage, activation_type)
VALUES ('Boogie Woogie', 50, '0', 'guaranteed');
...
INSERT INTO heavenly_restrictions(player_name, full_restriction, buff_category, buff_value, debuff_category, debuff_value)
VALUES ('Killua Zoldyk', 0, 'attack', '+1d2', 'defense', '-1d2');